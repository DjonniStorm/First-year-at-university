...
struct Image2 im2 = { 200, 300, 10, 0 };
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
	{
		...
		Images0(hdc, im1.x, im1.y, RGB(255, 255, 0));
		Images0(hdc, im2.x, im2.y, RGB(255, 255, 0));
		EndPaint(hWnd, &ps);
	}
	break;
	case WM_DESTROY:
